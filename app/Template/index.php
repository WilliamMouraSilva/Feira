...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="src/Template/css/bootstrap.css" rel="stylesheet">
    ...
    <!--<link href="vendor/twbs/bootstrap/docs/examples/theme/theme.css" rel="stylesheet">-->
    ...
    <script src="vendor/twbs/bootstrap/dist/js/valida.js"></script>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Feira do Rolo</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index.php">Home</a></li>
            <li><a href="page?=produtos">Produtos</a></li>
            <li><a href="route.php?class=sobre">Sobre</a></li>
            <li><a href="route.php?class=contato">Contato</a></li>
            <li><a href="?page=cadastro">Cadastre-se</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
